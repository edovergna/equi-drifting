...
class RadialBasis(torch.nn.Module):
    ...
    def forward(self, d):
        ...
        # The code is duplicated. Found copy of class in legacy version of
        # GET.radial_basis.py with this part added.
        # However, the code uses this version without the if statement
        # You could find it in utils.py in the original code.
        # leaving comments for debugging purposes.
