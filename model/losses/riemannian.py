...
from .kernel import molecule_kernel
from .geometry import product_tangent_norm, sphere_exp, geodesic_distance
...
def compute_molecule_based_drift_loss(
    ...
    # Target for atom types via the exponential mapping of the spherical space
